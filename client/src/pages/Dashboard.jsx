    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          className="w-6 h-6 text-[#CC9A06] dark:text-[#FFF3CD]" // Dynamic text color
        >
          <path
            ...
            fill="currentColor" // Dynamic path color
          />
        </svg>
      ),
      bgColor: "bg-[#FFF3CD] dark:bg-[#CC9A06]", // Dynamic background color
    }
  ...
  const paymentMetrics = [
    {
      ...
      icon: <HiBanknotes className="w-6 h-6 text-[#00BF2B] dark:text-[#D5FFE1]" />,
      bgColor: "bg-[#D5FFE1] dark:bg-[#00BF2B]"
    },
    {
      title: "Pending Revenue",
      value: `$${pendingRevenue.toLocaleString()}`,
      icon: <HiClock className="w-6 h-6 text-[#CC9A06] dark:text-[#FFF3CD]" />,
      bgColor: "bg-[#FFF3CD] dark:bg-[#CC9A06]"
    },
    {
      title: "Payment Conversion Rate",
      value: `${paymentConversionRate}%`,
      icon: <Percent className="w-6 h-6 text-[#1B8598] dark:text-[#D2F8FF]" />,
      bgColor: "bg-[#D2F8FF] dark:bg-[#1B8598]"
    }
  ];
